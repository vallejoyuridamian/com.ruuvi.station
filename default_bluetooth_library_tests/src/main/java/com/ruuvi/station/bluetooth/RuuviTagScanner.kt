...
class RuuviTagScanner(
    ...
    private var dataForwarder: IRuuviDataForwarder? = null
    ...
    fun setForwarder(forwarder: IRuuviDataForwarder){
    ...
    private var scanCallback = object : ScanCallback() {
        override fun onScanResult(callbackType: Int, result: ScanResult?) {
            ...
            result?.let {
                ...
                forwardData(leresult.scanData,leresult.rssi, leresult.device.address)
            }
        }
    ...
    private fun forwardData(data: ByteArray, rssi: Int, id: String) {
        dataForwarder?.forwardData(data, rssi, id)
    }
